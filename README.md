...
- [1. Arquitetura](#1-arquitetura)
  - [Camadas internas (por serviço)](#camadas-internas-por-serviço)
- [2. Serviços](#2-serviços)
- [3. Setup](#3-setup)
  - [Requisitos](#requisitos)
  - [Subir tudo](#subir-tudo)
- [4. Fluxo End-to-End](#4-fluxo-end-to-end)
  - [4.1 Registrar usuário](#41-registrar-usuário)
  - [4.2 Login (obtém JWT)](#42-login-obtém-jwt)
  - [4.3 Consultar Ford Ranger Raptor](#43-consultar-ford-ranger-raptor)
  - [4.4 Inspecionar trilha de auditoria (admin)](#44-inspecionar-trilha-de-auditoria-admin)
- [5. Mapa Cybersecurity → Implementação](#5-mapa-cybersecurity--implementação)
- [6. Padrões REST / SOA](#6-padrões-rest--soa)
- [7. Banco de dados & Migrations](#7-banco-de-dados--migrations)
- [8. Event Bus (RabbitMQ)](#8-event-bus-rabbitmq)
- [9. Estrutura do projeto](#9-estrutura-do-projeto)
- [10. Validação do desafio (Ford Ranger Raptor)](#10-validação-do-desafio-ford-ranger-raptor)
- [11. Testes automatizados (SOA)](#11-testes-automatizados-soa)
  - [Como rodar](#como-rodar)
  - [Cobertura por serviço](#cobertura-por-serviço)
  - [Evidência de execução](#evidência-de-execução)
- [12. Roadmap de testes manuais](#12-roadmap-de-testes-manuais)
- [13. Dev local (sem Docker)](#13-dev-local-sem-docker)
- [14. Tecnologias](#14-tecnologias)
- [15. Cybersecurity: Pipeline DevSecOps (C1)](#15-sprint-3--cybersecurity-pipeline-devsecops-c1)
  - [15.1 Diagrama do pipeline](#151-diagrama-do-pipeline)
  - [15.2 O que cada etapa reduz de risco](#152-o-que-cada-etapa-reduz-de-risco)
  - [15.3 Como isso rodaria no projeto Ford](#153-como-isso-rodaria-no-projeto-ford)
- [16. Cybersecurity: Segurança em Código e Infraestrutura (C2)](#16-sprint-3--cybersecurity-segurança-em-código-e-infraestrutura-c2)
  - [16.1 Criptografia local (dados em repouso)](#161-criptografia-local-dados-em-repouso)
  - [16.2 Hardening de API](#162-hardening-de-api)
  - [16.3 Controle de acesso por perfil (RBAC)](#163-controle-de-acesso-por-perfil-rbac)
  - [16.4 IaC security](#164-iac-security)
- [17. Cybersecurity: Observabilidade, Monitoramento e Resposta (C3)](#17-sprint-3--cybersecurity-observabilidade-monitoramento-e-resposta-c3)
  - [17.1 Logs estruturados](#171-logs-estruturados)
  - [17.2 Alterações críticas viram evento auditável](#172-alterações-críticas-viram-evento-auditável)
  - [17.3 Métricas e alertas](#173-métricas-e-alertas)
  - [17.4 Dashboards](#174-dashboards)
  - [17.5 Plano de resposta a incidentes](#175-plano-de-resposta-a-incidentes)
- [18. Cybersecurity: Compliance, Riscos e Segurança Contínua (C4)](#18-sprint-3--cybersecurity-compliance-riscos-e-segurança-contínua-c4)
  - [18.1 Revisão final de riscos (STRIDE + DevSecOps)](#181-revisão-final-de-riscos-stride--devsecops)
  - [18.2 Mapeamento com normas e boas práticas](#182-mapeamento-com-normas-e-boas-práticas)
  - [18.3 Plano de segurança contínua](#183-plano-de-segurança-contínua)
  - [18.4 Checklist de conformidade](#184-checklist-de-conformidade)
